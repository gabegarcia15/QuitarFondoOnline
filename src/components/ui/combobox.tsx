    ...
    <Headless.Combobox {...props} multiple={false} virtual={{ options: filteredOptions }} onClose={() => setQuery('')}>
      <span
        ...
        className={clsx([
          ...
          'dark:before:hidden',
          // Focus ring
          'after:pointer-events-none after:absolute after:inset-0 after:rounded-lg after:ring-transparent after:ring-inset sm:focus-within:after:ring-2 sm:focus-within:after:ring-red-500',
          // Disabled state
  ...
  return (
    <Headless.ComboboxOption
      ...
      className={clsx(
        ...
        // Focus
        'outline-hidden data-focus:bg-red-500 data-focus:text-white',
        // Forced colors mode
