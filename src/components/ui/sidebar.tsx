...
export const SidebarItem = forwardRef(function SidebarItem(
  ...
  const classes = clsx(
    ...
    // Hover
    'data-hover:bg-zinc-950/10 data-hover:*:data-[slot=icon]:text-zinc-950',
    // Active
    ...
    'dark:data-hover:bg-white/15 dark:data-hover:*:data-[slot=icon]:text-white',
    'dark:data-active:bg-white/20 dark:data-active:*:data-[slot=icon]:text-white',
